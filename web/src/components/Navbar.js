        ...
        <nav className="navbar">
            <div className="container navbar-inner">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    ...
                    <span style={{ fontSize: '0.85rem', fontFamily: 'var(--font-display)', fontStyle: 'italic', color: 'var(--primary-500)', marginTop: '-8px' }}>vastra : from local hands to your homes !</span>
                </div>
